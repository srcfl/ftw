...
install -m 0755 files/ftw-wifi-onboarding            "${ROOTFS_DIR}/usr/local/sbin/ftw-wifi-onboarding"
install -m 0644 files/ftw-wifi-onboarding.service    "${ROOTFS_DIR}/etc/systemd/system/ftw-wifi-onboarding.service"

on_chroot << 'EOF'
systemctl enable ftw-wifi-onboarding.service
