...
func TestGatewayIDFromMACCompatibilityVectors(t *testing.T) {
	// Source: srcful-blixt-x-firmware server/crypto/software.py at
	// 04bd6e09a2f9fd0fb7b884a7b7aa9077a5b208e3.
...
func TestNameWordListCompatibilityHashes(t *testing.T) {
	// Source: srcful-api GatewayNames at
	// 3992f1023951770756b0731ac1e4281349f273e2. Each hash covers every
	// word in order, joined by a newline and ending in a newline.
	vectors := []struct {
		name  string
		words []string
		want  string
...
func TestThreeWordNameCompatibilityVectors(t *testing.T) {
	// Source: srcful-api GatewayNames at
	// 3992f1023951770756b0731ac1e4281349f273e2. The FTW map has no
