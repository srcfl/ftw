...
type SolverInfo struct {
	...
	PreferenceStage        string         `json:"preference_stage,omitempty"`
	ImportPeakW            float64        `json:"import_peak_w,omitempty"`
	ExportPeakW            float64        `json:"export_peak_w,omitempty"`
	ServiceReport          *ServiceReport `json:"service_report,omitempty"`
	Fallback               bool           `json:"fallback,omitempty"`
	FallbackReason         string         `json:"fallback_reason,omitempty"`
}

// ServiceReport is the optimizer's account of unmet service: EV/storage
// energy shortfalls and thermal comfort slack. Grid peaks sit on SolverInfo
// because they are always defined for a complete plan.
type ServiceReport struct {
	FlexShortfallWh    map[string]float64 `json:"flex_shortfall_wh,omitempty"`
	StorageShortfallWh map[string]float64 `json:"storage_shortfall_wh,omitempty"`
	ThermalLowerSlackC map[string]float64 `json:"thermal_lower_slack_c,omitempty"`
	ThermalUpperSlackC map[string]float64 `json:"thermal_upper_slack_c,omitempty"`
}
