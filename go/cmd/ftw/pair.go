...
// runPair is the entry point for `ftw pair`.
//
//	ftw pair                       # 4h session
//	ftw pair --ttl 2h
//	ftw pair --intent "..." --as "@erikarenhill"
//	ftw pair --abort               # signal the running sidecar to exit
func runPair(args []string) {
	...
	bin := fs.String("bin", "", "Path to ftw-pair binary (default: sibling of ftw)")
	...
	// kills the parent (ftw pair) doesn't also SIGINT the
