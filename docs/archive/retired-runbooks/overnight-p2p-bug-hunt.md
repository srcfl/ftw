# Overnight goal bug-hunt — FTW P2P-only home route
...
`go/cmd/ftw/{owner_signal_loop.go,owner_relay_register.go,main.go}`,
...
- Create with `gh issue create --repo srcfl/ftw ...`. If `gh` is
