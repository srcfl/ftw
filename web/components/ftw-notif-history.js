...
export class FtwNotifHistory extends FtwElement {
  static styles = `
    ...
    .dot {
      ...
      border-radius: 10px; background: var(--red-e, #e57373); color: var(--on-accent, #0a0a0a);
    ...
    ftw-modal td.body    { color: var(--fg-dim, #a0a0a0); }
    ftw-modal .empty { padding: 24px; text-align: center; color: var(--fg-muted, #858585); }
