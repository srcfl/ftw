 ...
 * believable kWp and a quietly low one.
 */
...
/** Installable DC capacity for a roof area, matching the roof model's basis. */
export function kwpFromSlopeArea(areaM2, packingFactor, moduleWPerM2) {
  ...
  return (areaM2 * packing * wPerM2) / 1000;
}
...
export function arrayFromRing(ring, options) {
  ...
  return {
    array: {
      ...
      kwp: round(kwpFromSlopeArea(slope, opts.packingFactor, opts.moduleWPerM2), 2),
      tilt_deg: tiltDeg,
