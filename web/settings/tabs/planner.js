  ...
  S.tabs.planner = {
    render: function (ctx) {
      ...
      return '<fieldset><legend>MPC Planner</legend>' +
        ...
        selectField("Mode", "planner.mode", ["planner_self", "planner_cheap", "planner_arbitrage"], "planner_self",
          "planner_self = smart self-consumption (no grid charge, no export). planner_cheap = charge batteries during cheapest hours. planner_arbitrage = unrestricted buy-low / sell-high. Same values as the Dashboard's Strategy buttons.") +
