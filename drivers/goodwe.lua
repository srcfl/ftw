...
DRIVER = {
  ...
  verification_notes = "Ported from a reference implementation. Not yet verified against live hardware on a FTW site. GoodWe WiFi/LAN dongles are single-session: a hard controller reboot can leave a ghost Modbus TCP session; core applies TCP keepalive (15s) and exponential mute-reconnect backoff so the dongle can drop the ghost without a physical power cycle (#522).",
  connection_defaults = {
    port    = 502,
    unit_id = 1,
  },
