...
build:
	...
	cd go && go build -ldflags="$(LDFLAGS)" -o ../bin/ftw-pair-relay ./cmd/ftw-pair-relay
...
build-arm64:
	...
	cd go && GOOS=linux GOARCH=arm64 CGO_ENABLED=0 \
		go build -ldflags="$(LDFLAGS)" -o ../bin/ftw-pair-relay-linux-arm64 ./cmd/ftw-pair-relay
	@ls -la bin/forty-two-watts-linux-arm64 bin/ftw-pair-linux-arm64 bin/ftw-pair-relay-linux-arm64
...
build-amd64:
	...
	cd go && GOOS=linux GOARCH=amd64 CGO_ENABLED=0 \
		go build -ldflags="$(LDFLAGS)" -o ../bin/ftw-pair-relay-linux-amd64 ./cmd/ftw-pair-relay
	@ls -la bin/forty-two-watts-linux-amd64 bin/ftw-pair-linux-amd64 bin/ftw-pair-relay-linux-amd64
